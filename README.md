...
|Status|1987-2012|Tipo   |Nome |2013-2016|Tipo   |2017-2020|Tipo   |
|------|-------- |-------|-----|---------|-------|---------|-------|
|ok|`AnoBase`|`int64`|Ano Base de Coleta dos Dados |`AN_BASE`|`int64`|`AN_BASE`|`int64`|
|ok|`CodigoPrograma`|`object`|Código de Identificação do Programa|`CD_PROGRAMA`|`object`|`CD_PROGRAMA`|`object`|
|ok|`Regiao`|`object`|Nome do Programa|`NM_PROGRAMA`|`object`|`NM_PROGRAMA`|`object`|
|ok|`Uf`|`object`|Sigla da Entidade de Ensino|`SG_ENTIDADE_ENSINO`|`object`|`SG_ENTIDADE_ENSINO`|`object`|
|ok|`SiglaIes`|`object`|Nome da Entidade de Ensino|`NM_ENTIDADE_ENSINO`|`object`|`NM_ENTIDADE_ENSINO`|`object`|
|ok|`NomeIes`|`object`|Identificador do Produto no Ano Base e no Programa na Base de Dados da CAPES |`ID_ADD_PRODUCAO_INTELECTUAL`|`int64`|`ID_ADD_PRODUCAO_INTELECTUAL`|`int64`|
|ok|`NomePrograma`|`object`|Identificador do Produto na Base de Dados da CAPES|`ID_PRODUCAO_INTELECTUAL`|`int64`|`ID_PRODUCAO_INTELECTUAL`|`int64`|
|ok|`GrandeAreaCodigo`|`int64`|Nome da Produção |`NM_PRODUCAO`|`object`|`NM_PRODUCAO`|`object`|
|ok|`GrandeAreaDescricao`|`object`|Identificador do Subtipo da Produção|`ID_SUBTIPO_PRODUCAO`|`int64`|`ID_SUBTIPO_PRODUCAO`|`int64`|
|ok|`AreaConhecimentoCodigo`|`int64`|Nome do Subtipo da Produção |`NM_SUBTIPO_PRODUCAO`|`object`|`NM_SUBTIPO_PRODUCAO`|`object`|
|ok|`AreaConhecimento`|`object`|Identificador da área de concentração |`ID_AREA_CONCENTRACAO`|`float64`|`ID_AREA_CONCENTRACAO`|`float64`|
|ok|`AreaAvaliacao`|`object`|Nome da área de concentração |`NM_AREA_CONCENTRACAO`|`object`|`NM_AREA_CONCENTRACAO`|`object`|
|ok|`DocumentoDiscente`|`object`|Identificador da Linha de Pesquisa|`ID_LINHA_PESQUISA`|`float64`|`ID_LINHA_PESQUISA`|`float64`|
|ok|`Autor`|`object`|Nome da Linha de Pesquisa |`NM_LINHA_PESQUISA`|`object`|`NM_LINHA_PESQUISA`|`object`|
|ok|`TituloTese`|`object`|Identificador do Projeto |`ID_PROJETO`|`float64`|`ID_PROJETO`|`float64`|
|ok|`Nivel`|`object`|Nome do Projeto|`NM_PROJETO`|`object`|`NM_PROJETO`|`object`|
|ok|`DataDefesa`|`object`|Data e Hora do Início da Área de Concentração|`DH_INICIO_AREA_CONC`|`object`|`DH_INICIO_AREA_CONC`|`object`|
|ok|`PalavrasChave`|`object`|Data e Hora do Fim da Área de Concentração |`DH_FIM_AREA_CONC`|`object`|`DH_FIM_AREA_CONC`|`object`|
|ok|`Volume`|`int64`|Data e Hora do Início da Linha de Pesquisa |`DH_INICIO_LINHA`|`object`|`DH_INICIO_LINHA`|`object`|
|ok|`NumeroPaginas`|`int64`|Data e Hora do Fim da Linha de Pesquisa |`DH_FIM_LINHA`|`object`|`DH_FIM_LINHA`|`object`|
|ok|`BibliotecaDepositaria`|`object`|Data da Titulação |`DT_TITULACAO`|`object`|`DT_TITULACAO`|`object`|
|ok|`Idioma`|`object`|Descrição da Palavra Chave |`DS_PALAVRA_CHAVE`|`object`|`DS_PALAVRA_CHAVE`|`object`|
|ok|`ResumoTese`|`object`|Descrição do Abstract|`DS_ABSTRACT`|`object`|`DS_ABSTRACT`|`object`|
|ok|`LinhaPesquisa`|`object`|Descrição do Keyword |`DS_KEYWORD`|`object`|`DS_KEYWORD`|`object`|
|ok|`URLTextoCompleto`|`object`|Indicador de Expectativa de Atuação|`IN_TRABALHO_MESMA_AREA`|`float64`|`IN_TRABALHO_MESMA_AREA`|`int64`|
|ok|`DocumentoOrientador_1`|`object`|Nome do Tipo de vinculo|`NM_TP_VINCULO`|`object`|`NM_TP_VINCULO`|`object`|
|ok|`Orientador_1`|`object`|Indicador se o Orientador Participou da Banca |`IN_ORIENT_PARTICIPOU_BANCA`|`int64`|`IN_ORIENT_PARTICIPOU_BANCA`|`int64`|
|ok|`DocumentoOrientador_2`|`object`|Descrição da Biblioteca Depositária |`DS_BIBLIOTECA_DEPOSITARIA`|`object`|`DS_BIBLIOTECA_DEPOSITARIA`|`object`|
|ok|`Orientador_2`|`object`|Identificador do Tipo de Expectativa da Atuação|`ID_TP_EXPECTATIVA_ATUACAO`|`int64`|`ID_TP_EXPECTATIVA_ATUACAO`|`int64`|
|ok|`DocumentoOrientador_4`|`float64`|Nome da Expectativa da Atuação |`NM_EXPECTATIVA_ATUACAO`|`object`|`NM_EXPECTATIVA_ATUACAO`|`object`|
|ok|`Òrientador_4`|`float64`|Código de identificação da pessoa na base de dados da CAPES |`ID_PESSOA_DISCENTE`|`int64`|`ID_PESSOA_DISCENTE`|`int64`|
|ok|`DocumentoCoOrientador_1`|`object`|Nome do Discente |`NM_DISCENTE`|`object`|`NM_DISCENTE`|`object`|
|ok|`CoOrientador_1`|`object`|Data da Matrícula do Discente |`DT_MATRICULA`|`object`|`DT_MATRICULA`|`object`|
|ok|`DocumentoCoOrientador_2`|`object`|Identificador do Grau Acadêmico ao qual o discente está vinculado|`ID_GRAU_ACADEMICO`|`int64`|`ID_GRAU_ACADEMICO`|`int64`|
|ok|`CoOrientador_2`|`object`|Nome do Grau Acadêmico ao qual o discente está vinculado |`NM_GRAU_ACADEMICO`|`object`|`NM_GRAU_ACADEMICO`|`object`|
|ok|`DocumentoCoOrientador_3`|`object`|Nome do Orientador|`NM_ORIENTADOR`|`object`|`NM_ORIENTADOR`|`object`|
|ok|`CoOrientador_3`|`object`|Descrição da Categoria do Orientador|`DS_CATEGORIA_ORIENTADOR`|`object`|`DS_CATEGORIA_ORIENTADOR`|`object`|
|ok|`DocumentoCoOrientador_4`|`object`|Nome da Categoria do Docente |`NM_CATEGORIA_DOCENTE`|`object`|`NM_CATEGORIA_DOCENTE`|`object`|
|ok|`CoOrientador_4`|`object`|Nome da Região da IES |`NM_REGIAO`|`object`|`NM_REGIAO`|`object`|
|ok|-|-|Sigla da Unidade da Federação da IES |`SG_UF_IES`|`object`|`SG_UF_IES`|`object`|
|ok|-|-|Nome da Unidade da Federação da IES|`NM_UF_IES`|`object`|`NM_UF_IES`|`object`|
|ok|-|-|Código da Grande Área de Conhecimento a que a Produção está vinculada |`CD_GRANDE_AREA_CONHECIMENTO`|`int64`|`CD_GRANDE_AREA_CONHECIMENTO`|`int64`|
|ok|-|-|Nome da Grande Área de Conhecimento a que a Produção está vinculada |`NM_GRANDE_AREA_CONHECIMENTO`|`object`|`NM_GRANDE_AREA_CONHECIMENTO`|`object`|
|ok|-|-|Código da Área de Conhecimento a que o Programa de Pós-Graduação está vinculada|`CD_AREA_CONHECIMENTO`|`float64`|`CD_AREA_CONHECIMENTO`|`float64`|
|ok|-|-|Nome da Área de Conhecimento a que o Programa de Pós-Graduação está vinculada|`NM_AREA_CONHECIMENTO`|`object`|`NM_AREA_CONHECIMENTO`|`object`|
|ok|-|-|Código da Subárea de Conhecimento a que o Programa de Pós-Graduação está vinculada |`CD_SUBAREA_CONHECIMENTO`|`float64`|`CD_SUBAREA_CONHECIMENTO`|`float64`|
|ok|-|-|Nome da Subárea de Conhecimento a que o Programa de Pós-Graduação está vinculada |`NM_SUBAREA_CONHECIMENTO`|`object`|`NM_SUBAREA_CONHECIMENTO`|`object`|
|ok|-|-|Código da Especialidade |`CD_ESPECIALIDADE`|`float64`|`CD_ESPECIALIDADE`|`float64`|
|ok|-|-|Nome da Especialidade|`NM_ESPECIALIDADE`|`object`|`NM_ESPECIALIDADE`|`object`|
|ok|-|-|Nome da Área de Avaliação |`NM_AREA_AVALIACAO`|`object`|`NM_AREA_AVALIACAO`|`object`|
|ok|-|-|Número do Volume da Produção|`NR_VOLUME`|`object`|`NR_VOLUME`|`object`|
|ok|-|-|Número de Páginas da Produção |`NR_PAGINAS`|`float64`|`NR_PAGINAS`|`float64`|
|ok|-|-|Nome do Idioma da Produção |`NM_IDIOMA`|`object`|`NM_IDIOMA`|`object`|
|ok|-|-|Descrição do Resumo|`DS_RESUMO`|`object`|`DS_RESUMO`|`object`|
|ok|-|-|Descrição da URL do Texto Completo|`DS_URL_TEXTO_COMPLETO`|`object`|`DS_URL_TEXTO_COMPLETO`|`object`|
|ok|-|-|Código de identificação da pessoa orientador na base de dados da CAPES |`ID_PESSOA_ORIENTADOR`|`float64`|`ID_PESSOA_ORIENTADOR`|`float64`|
|ok|-|-|Indicada se o TCC tem vínculo com alguma Produção Intelectual |-|-|`IN_TCC_COM_VINCULO_PRODUCAO`|`object`|
|ok|-|-|Representa os 'IDs' das produções intelectuais concatenadas, para caso o usuário deseje saber qual produção intelectual foi vinculada aquele TCC |-|-|`ID_ADD_PRODUCAO_VINCULO_CT`|`object`|
